...
<div class="shadow rounded-3 p-3 mt-4" style="background-color: var(--bs-body-bg)">
    <div class="d-flex justify-content-between align-items-center mb-4 mt-2">
        <h6 class="fw-semibold">Tabel semua tugas</h6>
    ...
    <div class="collapse mb-4" style="transition: 0.3s ease-in-out" id="toggleFilter">
        <div class="card border-0 card-body">
            <form action="/tugas/tugasAll" method="get">
                @csrf
                <div class="row">
                ...
                <button type="submit" class="btn btn-sm btn-primary w-25 mt-2">Filter</button>
            </form>
        </div>
    </div>
                ...
                @else
                    <tr>
                        <td class="text-center text-secondary py-5" colspan="100">
                            ...
                            <p class="my-0">There is no project now</p>
                        </td>
                    </tr>
                @endif
            </tbody>
    ...
    <div class="flex-between-center mt-3">
        <a href="/dashboard" class="text-decoration-none fw-semibold" style="color: var(--bs-body-color);"><i class="fa fa-fw fa-arrow-left"></i> Back</a>
    </div>
</div>
@endsection